...
public class Skel_Sword_Monster : SkelManager
{
    private void Start()
    {
    ...
    private void FixedUpdate()
    {
        ...
        if (isAttack && (WeaponAnim.GetCurrentAnimatorStateInfo(0).IsName("Skel_ShortSword_Attack") && WeaponAnim.GetCurrentAnimatorStateInfo(0).normalizedTime > 0.6f))
        {
            // 공격
            Attack();
        }
    ...
    public override void Attack()
    {
        ...
        if (players != null)
        {
            ...
            {
                GameManager.instance.failCause = "스켈레톤 전사에게 패배"; // 사망 이유
